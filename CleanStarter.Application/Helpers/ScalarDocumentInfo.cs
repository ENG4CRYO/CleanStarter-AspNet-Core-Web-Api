namespace CleanStarter.Application.Helpers
{
    public static class ScalarDocumentInfo
    {
        ...
        {
            string template = """
                # 🏗️ CleanStarter Enterprise API Guide
                Welcome to the official developer documentation for the **CleanStarter** platform. This API is built using **.NET 9**, following **Clean Architecture** and **CQRS** patterns with a focus on high security and performance.
                ...
                * **Test Credentials:** * Email: `tester@cleanstarter.com`
